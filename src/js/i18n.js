(() => {
  ...
  const contentEntries = [
    ...
    {
      selector: '.project-card:nth-of-type(1) .project-card__type',
      value: 'HealthTech · Product'
    },
    {
      selector: '.project-card:nth-of-type(1) .project-card__body > p',
      value: 'A digital product that supports wound monitoring through a clear, healthcare-focused experience.'
    },
    {
      selector: '.project-card:nth-of-type(2) .project-card__body > p',
    ...
    {
      selector: '.project-card:nth-of-type(4) .project-card__type',
    ...
    },
    {
      ...
      value: 'Code <i class="fa-brands fa-github"></i>'
    },
    {
